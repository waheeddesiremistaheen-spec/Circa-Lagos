...
(function () {
  ...
  const SPEED = 0.08;          // slower, more elegant
  ...
  let animActive = true;       // will be controlled by IntersectionObserver
  ...
  function createBlobs() {
    ...
    for (let i = 0; i < BLOB_COUNT; i++) {
      blobs.push({
        ...
        radius: 200 + Math.random() * 180,   // smaller range
  ...
  // ===== Animation Loop (only draws if active) =====
